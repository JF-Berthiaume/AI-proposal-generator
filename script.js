document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        fr: {
            ...
            'demo-type': 'Type de mandat?',
            'demo-btn-web': 'Consultation',
            'demo-btn-mobile': 'Service',
            'demo-btn-ai': 'Projet',
            'demo-describe': 'Décrivez le besoin.',
            'demo-user-need': 'Refonte de site web et stratégie numérique. Budget 15 000$ plus 150$/mois, entente de 2 ans.',
            'demo-confirm': 'Budget 15 000$ + 150$/mois (2 ans). Inclure les conditions de paiement?',
            'demo-btn-yes': 'Oui',
            'demo-btn-no': 'Non',
            'demo-generating': 'Génération de votre proposition...',
            'demo-ready': '✓ Proposition prête!',
            'demo-file-name': 'Proposition_Mediamax.pdf',
            ...
            'onboard-services-ok': '✓ 3 services enregistrés.',
            'onboard-import': 'Importer une ancienne proposition comme référence?',
            'onboard-btn-import': '📄 Importer',
            'onboard-btn-skip': 'Passer',
            'onboard-file': 'Proposition_Refonte_2025.pdf',
            'onboard-import-ok': '✓ Proposition importée — votre style sera appliqué.',
        ...
        en: {
            ...
            'demo-type': 'Type of mandate?',
            'demo-btn-web': 'Consulting',
            'demo-btn-mobile': 'Service',
            'demo-btn-ai': 'Project',
            'demo-describe': 'Describe the need.',
            'demo-user-need': 'Website redesign and digital strategy. Budget $15,000 plus $150/mo, 2-year agreement.',
            'demo-confirm': 'Budget $15,000 + $150/mo (2 years). Include payment terms?',
            'demo-btn-yes': 'Yes',
            'demo-btn-no': 'No',
            'demo-generating': 'Generating your proposal...',
            'demo-ready': '✓ Proposal ready!',
            'demo-file-name': 'Proposal_Mediamax.pdf',
            ...
            'onboard-services-ok': '✓ 3 services saved.',
            'onboard-import': 'Import a past proposal as reference?',
            'onboard-btn-import': '📄 Import',
            'onboard-btn-skip': 'Skip',
            'onboard-file': 'Proposal_Redesign_2025.pdf',
            'onboard-import-ok': '✓ Proposal imported — your style will be applied.',
